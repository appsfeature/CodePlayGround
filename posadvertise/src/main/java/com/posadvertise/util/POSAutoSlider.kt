...
class POSAutoSlider(private val viewPager: ViewPager2?, private val indicatorView: WormDotsIndicator?, private val mTransitionTime : Long) : DefaultLifecycleObserver{
