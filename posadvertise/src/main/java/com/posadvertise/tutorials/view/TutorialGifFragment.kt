...
class TutorialGifFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        mTutorial = arguments?.getParcelable(BaseConstants.EXTRA_PROPERTY)
        mTutorial?.let {
    ...
    private fun getImageUri(context: Context, fileName: String): Uri {
        val folder = POSFileManager.getPOSTutorialFolder(context)
        return POSFileManager.getUriFromFile(context, File(folder, fileName))
    }
